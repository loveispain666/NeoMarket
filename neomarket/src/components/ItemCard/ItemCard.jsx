...
const ItemCard = ({ id, text, price, img }) => {
	...
	return (
		<div className={styles.oooo}>
			...
			<div className={styles.card} onClick={() => { navigate(`catalog/${id}/`) }}>
